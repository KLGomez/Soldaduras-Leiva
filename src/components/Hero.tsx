...
export function Hero() {
  return (
    <section id="inicio" className="relative text-white py-24 md:py-40 lg:py-56 overflow-hidden min-h-screen flex items-center">
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 lg:px-8 py-8 md:py-12 lg:py-20 w-full">
        <div className="max-w-2xl backdrop-blur-sm bg-black/30 p-8 md:p-12 lg:p-16 ">
